              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-1 min-w-0 overflow-x-auto">
                    <span className="text-xs shrink-0 hidden sm:block" style={{ color: isDark ? "rgba(255,255,255,0.3)" : "var(--text-muted)" }}>
                      {t.inputLabel}
                    </span>
                    <span className="text-xs shrink-0" style={{ color: isDark ? "rgba(255,255,255,0.5)" : "var(--text-secondary)" }}>{wf.input}</span>
                    ...
                    <ArrowRight size={11} className="shrink-0" style={{ color: isDark ? "rgba(255,255,255,0.2)" : "rgba(79,70,229,0.35)" }} />
                    <span className="text-xs shrink-0" style={{ color: isDark ? "rgba(255,255,255,0.6)" : "var(--text-secondary)" }}>{wf.output}</span>
                  </div>
